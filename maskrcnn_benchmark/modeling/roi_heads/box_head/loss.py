...
class FastRCNNLossComputation_component(object):
    ...
    def match_targets_to_proposals(self, proposal, target):
        ...
        #==================2021 04 23 修改 =========================
        # target额外添加components信息
        target = target.copy_with_fields(["labels", "components"])
    ...
    def prepare_targets(self, proposals, targets):
        ...
        for proposals_per_image, targets_per_image in zip(proposals, targets):
            ...
            # ==================2021 04 23 修改 =========================
            # 添加components的信息
            components_per_image = matched_targets.get_field("components")
            components_per_image = components_per_image.to(dtype=torch.int64)
            ...
            # ==================2021 04 23 修改 =========================
            # 照葫芦画瓢 给components设置背景类
            components_per_image[bg_inds] = 0
            ...
            # ==================2021 04 23 修改 =========================
            # 照葫芦画瓢 对components进行操作
            components.append(components_per_image)

            regression_targets.append(regression_targets_per_image)

        return labels, components, regression_targets
    ...
    def subsample(self, proposals, targets):
        ...
        labels, components, regression_targets = self.prepare_targets(proposals, targets)
        # 按照一定的方式选取背景框和目标边框，并返回其标签索引 得到列表类型
        ...
        for labels_per_image, components_per_image, regression_targets_per_image, proposals_per_image in zip(
            ...
            proposals_per_image.add_field("labels", labels_per_image)
            proposals_per_image.add_field("components", components_per_image)
    ...
    def __call__(self, class_logits, component_logits, box_regression):
        ...
        # ==================2021 04 23 修改 =========================
        component_loss = F.cross_entropy(component_logits, components)
        ...
        return classification_loss, component_loss, box_loss
